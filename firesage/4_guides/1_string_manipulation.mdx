...
It is important to understand how Typescript string literal works Typescript can understand the type of your path and key.
...
<Image
	src="https://github.com/tylim88/FirelordJSDoc/blob/main/static/firesage/string1.png?raw=true"
...
<Image
	src="https://github.com/tylim88/FirelordJSDoc/blob/main/static/firesage/string2.png?raw=true"
