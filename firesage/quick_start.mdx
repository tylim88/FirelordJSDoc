...
You should also assume all paths, keys and values are narrowly typed.
...
// union Removable in any way, eg { g : PushAbleOnly<{ h: number | Removable } | Removable> } | Removable
```
