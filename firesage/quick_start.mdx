...
:::tip
Every detail or rule stated in the code below may sound like runtime validation or something you have to remember and obey, but they are in fact type level validation.

Unless stated explicitly, eg: 'this is a runtime check' or 'you have to remmeber', you should assume everything you read is type level validation.

I hope by now you are aware of "Extreme Type Safe" is not an exaggeration.
:::
