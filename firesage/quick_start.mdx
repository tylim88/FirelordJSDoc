...
I hope by now you are aware that "Extreme Type Safe" is not an exaggeration😉.
...
export type Example = MetaTypeCreator<{
	...
	i: PseudoArray<string> // Firesage replaces all numeric key node { 1:'a', 2:'b', 3:'c' } with error message, use PseudoArray instead
}>
```
