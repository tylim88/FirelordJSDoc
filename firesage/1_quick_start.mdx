...
The library size on disk is 300KB, most of the code are type definitions and comments, the runtime code is at mere 5KB after minified and gzipped(based on rollup).
