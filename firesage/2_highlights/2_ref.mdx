...
1. The key of `Record<string, T>` is always non-numeric(this includes alphanumeric)
...
Due to complexity, this is not something that could be easily improved, will give this a deeper thought in the future.
