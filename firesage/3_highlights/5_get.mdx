...
So with child of child because they data snapshots are recursively typed!
...
Due to complexity, this error message is too generic, will give it a deeper thought in the future.
