...
The library size on disk is 350KB and tests, most of the code are type definitions, the runtime code is at mere 6KB after minified and gzipped.

:::

:::tip
FirelordRN API is almost exactly as same as [Firelord](https://firelordjs.com/firelord/quick_start), which mean:
...
```ts title='init.ts'
import { getFirelord } from 'firelordrn'
