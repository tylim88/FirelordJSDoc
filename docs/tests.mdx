...
:::note
You can use any test you want, it doesn't have to be `@firebase/rules-unit-testing`, however using `@firebase/rules-unit-testing` can save you a lot of brain cells and it is the recommended way.
