...
Very elegant API, as expected from the author of `date-fns`. Typesaurus is created before Firestore Web V9 and the API somehow resembles V9, the statement "Typesaurus inspired V9 API" is believe able.
