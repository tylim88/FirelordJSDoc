...
Strongly not recommended, it is just too painful, too much mental barrier.

Support only Firestore Admin (Firestore Admin V9 did not undergo API revamp like Firestore Web V9).
