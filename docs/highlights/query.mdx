...
FirelordJS protects you against runtime exceptions in your queries on type level.
...
<Image src='https://github.com/tylim88/FirelordJSDoc/blob/main/static/img/query6.png?raw=true' text='FirelordJS displays what error you make in the hint.'/>
...
<Image src='https://github.com/tylim88/FirelordJSDoc/blob/main/static/img/query7.png?raw=true' text='FirelordJS displays what error you make in the hint.'/>

- You cannot use more than one '!=' filter (undocumented limitation)

<Image src='https://github.com/tylim88/FirelordJSDoc/blob/main/static/img/query8.png?raw=true' text='FirelordJS displays what error you make in the hint.'/>