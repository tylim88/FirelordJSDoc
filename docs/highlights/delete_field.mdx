...
2. To use deleteField in update operation, you can only use it on top level (no nested object, full dot notation is considered as top level.)

:::note

<div align="center">
	<i>Its is a prank bro, a prank! &#160;&#160;&#160;--Firestore</i>{' '}
</div>
<br />
...
Seriously who designed these APIs, they are terrible!

<br />

<Image
	src="https://github.com/tylim88/FirelordJSDoc/blob/main/static/img/deleteField6.png?raw=true"
	text="some smart guy in Firebase decided that convulated rule like this is a good idea"
/>
