...
1. To use deleteField in set operation, you need to set merge to true, or have any merge field(empty array also works). The exceptions:

:::info

Function setDoc() called with invalid data. deleteField() cannot be used with set() unless you pass {merge:true} (found in field a.b.c in document sandBox/mergeTestCase)
...
Function updateDoc() called with invalid data. deleteField() can only appear at the top level of your update data (found in field a.b.c in document sandBox/mergeTestCase)
...
Seriously who make these APIs, they are terrible!
...
<div align="center">
	<i>
		Don't be mad bro, it is just a prank, a prank! &#160;&#160;&#160;--Firestore
	</i>{' '}
</div>
<br />
...
<Image
	...
	text="FirelordJS prevent you from doing it the wrong way and provide guide line in hint."
/>
