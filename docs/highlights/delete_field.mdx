...
:::note this is how the exception look like:
...
<br />
<Image
	src="https://github.com/tylim88/FirelordJSDoc/blob/main/static/img/kidding.png?raw=true"
	text=""
/>
...
You are safe against set no merge options, set { merge:false } and update low level exceptions, no room for errors.
