...
const firelordRef = getFirelord<Example>()

export const example = firelordRef('SomeCollectionName')
```
...
## Did I Just Learn Everything In A Page?

You basically learned 95% of FirelordJS API, in just one page.

The knowledge gap between casual user and advanced user is just 5%.
