...
// Recommendation: Export this if the collection is sub-collection and then fill in the value later, because sub collection has multiple dynamic document ID.
