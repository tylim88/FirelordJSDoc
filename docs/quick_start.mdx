...
support **[@firebase/rules-unit-testing](/highlights/tests)**
...
const firelordRef = getFirelord<Example>(db) // or getFirelord<Example>()
...
const batch = writeBatch() // or writeBatch(db)
...
try {
	await runTransaction(async transaction => {
		// or await runTransaction(db, async transaction => {...})
