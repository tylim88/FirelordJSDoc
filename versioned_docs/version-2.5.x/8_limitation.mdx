...
4: technically possible (already in use internally). By utilizing Typesript distributive properties it is possible to generate path for object literal unions field.
