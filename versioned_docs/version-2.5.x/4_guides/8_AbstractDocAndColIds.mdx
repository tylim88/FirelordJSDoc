...
Keep in mind that document and collection ids are array, sub collection document reference has more than one id that you need to define, read more in [MetaType](./metatype)
