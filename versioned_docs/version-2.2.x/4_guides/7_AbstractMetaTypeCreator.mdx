...
# Abstract Meta Type Creator

This section show you how to do abstraction with FirelordJS.

The example below show you how to add `updatedAt` field to all your update operation.
