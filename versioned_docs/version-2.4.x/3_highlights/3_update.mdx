...
_Why not forbid developers from using nested form? It would be easier for developers to revert to official SDK._

The reason is simple: usability. If FirelordJS only allows dot notation form, developers have to flatten objects by themselve.
