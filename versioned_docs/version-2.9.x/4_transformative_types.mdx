...
| [`DeleteField`](./api/delete_field)                           | `undefined`                               | `never` for set, add and create. `DeleteField` for update and set merge               | `never`                                   |
| [`PossiblyReadAsUndefined`](./api/possibly_read_as_undefined) | `undefined`                               | `never`                                                                               | `never`                                   |
