...
The library size on disk is 300KB, most of the code are type definitions and comments, the runtime code is at mere 9KB after minified and gzipped, [see how we got this number](/1.x.x/minified_size).
