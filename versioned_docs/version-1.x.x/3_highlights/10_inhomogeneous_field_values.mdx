...
| Field Value | Interface                                                             | Signature                                  | Note                                                | Assignable |
| ----------- | --------------------------------------------------------------------- | ------------------------------------------ | --------------------------------------------------- | ---------- |
| `delete`    | [`DeleteField`](/1.x.x/guides/delete_field)                           | `{ 'Firelord.FieldValue': unique symbol }` | allow a field to be read as undefiend and deletable | Yes        |
| none        | [`PossiblyReadAsUndefined`](/1.x.x/guides/possibly_read_as_undefined) | `{ 'Firelord.FieldValue': unique symbol }` | allow a field to be read as undefiend               | Yes        |

Special types serve as utility, eg: transform into another type or allow you to perform certain action to a field.
