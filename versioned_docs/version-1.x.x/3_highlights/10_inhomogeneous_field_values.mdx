...
| Interface                                                                 | Note                                                |
| ------------------------------------------------------------------------- | --------------------------------------------------- |
| [`DeleteField`](../4_guides/3_delete_field.mdx)                           | allow a field to be read as undefiend and deletable |
| [`PossiblyReadAsUndefined`](../4_guides/5_possibly_read_as_undefined.mdx) | allow a field to be read as undefiend               |

These are virtual types, they serve as utility, they are assignable but cannot be accessed in runtime.
