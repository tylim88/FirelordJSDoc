...
The official SDK does not have distinct type for server timestamp, all field values in Firestore have the same type, that is `FieldValue`, read **[Inhomogeneous Field Values](/1.x.x/highlights/inhomogeneous_field_values)** for more info.

:::

<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
	<img src="/firelord/get1.png" />
	<small>Firestore</small>
</div>
<br />
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
	<img src="/firelord/get2.png" />
	<small>
