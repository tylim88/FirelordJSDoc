...
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
	<img src="/firelord/set1.png" />
	<small>Firestore</small>
</div>
<br />
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
	<img src="/firelord/set2.png" />
...
see **[update](/1.x.x/highlights/update#the-firelordjss-way)** for more explanation about this behavior.
...
<div  style={{ display:'flex', justifyContent:'space-around' }}>
    <div style={{ display:'flex', flexDirection:"column", alignItems:'center' }}>
        <img src='/firelord/set3.png' />
        <small>Firestore</small>
    </div>
    <div style={{ display:'flex', flexDirection:"column", alignItems:'center' }}>
        <img src='/firelord/set4.png' />
...
From **[update](/1.x.x/highlights/update#the-firelordjss-way)**, we know that when dealing with nested form, update behaves like set and replace the whole map.
...
<div  style={{ display:'flex', justifyContent:'space-around' }}>
    <div style={{ display:'flex', flexDirection:"column", alignItems:'center' }}>
        <img src='/firelord/set7.png' />
        <small>Firestore</small>
    </div>
    <div style={{ display:'flex', flexDirection:"column", alignItems:'center' }}>
        <img src='/firelord/set8.png' />
        <small>FirelordJS</small>
    </div>
</div>
<br/>
...
Will give this deeper thoughts in future.
