...
A perfect solution is to forbid set merge and only allow set merge on field that has special type(like how delete field works), will give this deeper thoughts in V2.
