...
And they all sharing the same type: `FieldValue`, which means is it possible to assign any field value to any field value, a big pain in the ass.
...
Labels are FirelordJS special interfaces, you can use them to "mark" you field and they will carry out extra type transformation or allow you to perform certain action onto your field.
...
| -           | [`PossiblyReadAsUndefined`](./guides/possibly_read_as_undefined) | `{ 'Firelord.FieldValue': unique symbol }` | allow a field to be read as undefiend               | Yes        |
