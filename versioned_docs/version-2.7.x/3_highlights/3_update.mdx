...
But apparently it has [use cases](https://github.com/tylim88/Firelord/issues/20#issuecomment-1545975918), so I added `transaction.updateNoFlatten`, `batch.updateNoFlatten`, and `updateDocNoFlatten` for those who needs the original behavior.
