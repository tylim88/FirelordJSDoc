...
| ----------- | ------------------------------------------------------------- | ------------------------------------------ | --------------------------------------------------- | ---------- |
| `delete`    | [`DeleteField`](./api/delete_field)                           | `{ 'Firelord.FieldValue': unique symbol }` | allow a field to be read as undefiend and deletable | Yes        |
| -           | [`PossiblyReadAsUndefined`](./api/possibly_read_as_undefined) | `{ 'Firelord.FieldValue': unique symbol }` | allow a field to be read as undefiend               | Yes        |
