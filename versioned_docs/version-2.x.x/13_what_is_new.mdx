...
This section discuss what problem V2 solved.
...
Despite `colGroupRef` not needing any document ID, we still need to supply two documentIDs for it.

No matter how we look at this pattern, it is harmful to your code structure because the way of exporting top level ref and child ref are different.
...
read here for more about [Child Meta Type](./guides/child_metatype)

## Should I Update to V2?

You can stay with V1 but we strongly recommend you use V2 in your future project.
