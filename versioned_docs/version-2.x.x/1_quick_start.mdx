...
Coming from V1? See [what is new in V2](/13_what_is_new.mdx).
...
The library size is 300KB, most of the code are type definitions and comments, the runtime code is at mere 9KB after minified and gzipped, [see how we got this number](/minified_size).
