...
Looking for [Admin](/firelord/quick_start) version?
...
The library size on disk is 300KB, most of the code are type definitions and comments, the runtime code is at mere 9KB after minified and gzipped, [see how we got this number](/minified_size).
