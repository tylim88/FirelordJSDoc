...
Firestore does not have distinct type for server timestamp, all field values in Firestore have the same type, that is `FieldValue`, read **[Inhomogeneous Field Values](/highlights/inhomogeneous_field_values)** for more info.

:::

<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
	<img src="https://github.com/tylim88/FirelordJSDoc/blob/main/static/firelordv2/get1.png?raw=true" />
	<small>Firestore</small>
</div>
<br />
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
	<img src="https://github.com/tylim88/FirelordJSDoc/blob/main/static/firelordv2/get2.png?raw=true" />
	<small>
...
<div style={{ display: 'flex', justifyContent: 'space-around' }}>
	...
	>
		<img src="https://github.com/tylim88/FirelordJSDoc/blob/main/static/firelordv2/get3.png?raw=true" />
		<small>
...
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
	<img src="https://github.com/tylim88/FirelordJSDoc/blob/main/static/firelordv2/get4.png?raw=true" />
...
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
	<img src="https://github.com/tylim88/FirelordJSDoc/blob/main/static/firelordv2/get5.png?raw=true" />
