...
| Interface                                                         | Note                                                |
| ----------------------------------------------------------------- | --------------------------------------------------- |
| [`DeleteField`](../guides/delete_field)                           | allow a field to be read as undefiend and deletable |
| [`PossiblyReadAsUndefined`](../guides/possibly_read_as_undefined) | allow a field to be read as undefiend               |
