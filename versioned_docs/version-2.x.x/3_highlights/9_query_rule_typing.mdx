...
<Image
	src="https://github.com/tylim88/FirelordJSDoc/blob/main/static/firelordv2/query2.png?raw=true"
...
<Image
	src="https://github.com/tylim88/FirelordJSDoc/blob/main/static/firelordv2/query3.png?raw=true"
	text="FirelordJS displays which query rule you violated in the hint."
/>
...
<Image
	src="https://github.com/tylim88/FirelordJSDoc/blob/main/static/firelordv2/query4.png?raw=true"
	text="FirelordJS displays which query rule you violated in the hint."
/>
...
<Image
	src="https://github.com/tylim88/FirelordJSDoc/blob/main/static/firelordv2/query5.png?raw=true"
	text="FirelordJS displays which query rule you violated in the hint."
/>
...
<Image
	src="https://github.com/tylim88/FirelordJSDoc/blob/main/static/firelordv2/query6.png?raw=true"
	text="FirelordJS displays which query rule you violated in the hint."
/>
...
<Image
	src="https://github.com/tylim88/FirelordJSDoc/blob/main/static/firelordv2/query7.png?raw=true"
	text="FirelordJS displays which query rule you violated in the hint."
/>
...
<Image
	src="https://github.com/tylim88/FirelordJSDoc/blob/main/static/firelordv2/query8.png?raw=true"
	text="FirelordJS displays which query rule you violated in the hint."
/>
