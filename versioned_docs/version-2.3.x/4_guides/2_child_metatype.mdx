...
export const parentRef = getFirelord<Child>(
	db,
...
const parentDocRef = parentRef.doc(
	'docIDLevel1' // parent doc ID
)
const childDocRef = childRef.doc(
	'docIDLevel1', // parent doc ID
...
const childColRef = childRef.collection(
	'docIDLevel1' // parent doc ID
)
const grandChildColRef = grandChildRef.collection(
	'docIDLevel1', // parent doc ID
	'docIDLevel2' // child doc ID
)
