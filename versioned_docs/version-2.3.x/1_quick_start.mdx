...
[v2.3.1](https://github.com/tylim88/FirelordJS/releases/tag/2.3.1) and [v2.3.2](https://github.com/tylim88/FirelordJS/releases/tag/2.3.2) remove most of the need to assert as const, however there are still some cases require you to do const asseertion.
