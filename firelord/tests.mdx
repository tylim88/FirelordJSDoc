...
:::tip
Firestore Admin doesnt require `@firebase/rules-unit-testing` to test. And unlike the web version, in admin version you can skip the firestore instance parameter for everything.
:::
