...
:::tip
Firelord API is almost exactly as same as [FirelordJS](https://firelordjs.com/quick_start/quick_start), which mean:

1. Tthey share basically the same documentation, hence we will skip most of the documentation to avoid repetition.
...
To learn more, read the [Web]('https://firelordjs.com/quick_start/quick_start') section.
